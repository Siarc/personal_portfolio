          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p style={{ color: currentTheme.colors.textSecondary }}>Email</p>
                  <p
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p style={{ color: currentTheme.colors.textSecondary }}>Phone</p>
                  <p
                    className="font-medium"
                    style={{ color: currentTheme.colors.text }}
                  >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p style={{ color: currentTheme.colors.textSecondary }}>Location</p>
                  <p
                    className="font-medium"
                    style={{ color: currentTheme.colors.text }}
                  >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {status === 'error' && (
                ...
                >
                  ❌ Failed to send message. Please try again or contact me directly at aminul.irony@gmail.com
                </motion.div>
              )}
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full py-3 font-medium rounded-lg transition-opacity"
                style={{
                  background: isLoading
                    ? currentTheme.colors.border
                    : `linear-gradient(to right, ${currentTheme.colors.primary}, ${currentTheme.colors.secondary})`,
                  color: isLoading ? currentTheme.colors.textSecondary : getButtonTextColor(currentTheme),
                ...
                {isLoading ? (
                  <div className="flex items-center justify-center space-x-2">
                    <div
                      ...
                      style={{ borderColor: currentTheme.colors.text + ' transparent transparent transparent' }}
                    ></div>
                    <span>Sending...</span>
                  </div>
                ) : (
